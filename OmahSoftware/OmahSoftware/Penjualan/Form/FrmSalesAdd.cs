...
namespace OmahSoftware.Penjualan {
    public partial class FrmSalesAdd : DevExpress.XtraEditors.XtraForm {
        private String id = "SALES";
        private String dokumen = "SALES";
        private Boolean isAdd;
        public String kode;

        public FrmSalesAdd(bool pIsAdd) {
            isAdd = pIsAdd;
            InitializeComponent();
        }
        ...
        private void setDefaultInput(MySqlCommand command) {
            if(!this.isAdd) {
                ...
                // data
                DataSales dSales = new DataSales(command, strngKode);
                txtNama.EditValue = dSales.nama;
                chkStatus.Checked = dSales.status == Constants.STATUS_AKTIF;
        ...
        private void btnSimpan_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                DataSales dSales = new DataSales(command, strngKode);
                dSales.nama = strngNama;
                dSales.status = strngStatus;
                ...
                // tulis log
                OswLog.setTransaksi(command, dokumen, dSales.ToString());

                // reload grid di form header
                FrmSales frmSales = (FrmSales)this.Owner;
                frmSales.setGrid(command);
