...
namespace OmahSoftware.Penjualan {
    public partial class FrmBackOrder : DevExpress.XtraEditors.XtraForm {
        ...
        private void FrmBackOrder_Load(object sender, EventArgs e) {
            ...
            try {
                ...
                cmbStatus = ComboConstantUmum.getStatusBackOrder(cmbStatus, true);
        ...
        public void setGrid(MySqlCommand command) {
            ...
            String query = @"SELECT A.kode AS Nomor, A.tanggal AS Tanggal, B.nama AS Customer, D.nama AS Kota, A.catatan AS Catatan, A.grandtotal AS Total, A.status AS Status
                            FROM backorder A
                            ...
                            WHERE toDate(A.tanggal) BETWEEN toDate(@tanggalawal) AND toDate(@tanggalakhir) AND                                   
                                  A.kode LIKE @kode AND A.customer LIKE @customer AND A.status LIKE @status
                            ORDER BY A.kode";
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmBackOrderAdd form = new FrmBackOrderAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmBackOrderAdd form = new FrmBackOrderAdd(true);
            this.AddOwnedForm(form);
            form.ShowDialog();
        }
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if(OswPesan.pesanKonfirmasiHapus() == DialogResult.Yes) {
                    ...
                    // tulis log
                    OswLog.setTransaksi(command, "Hapus " + dokumen, dBackOrder.ToString());
