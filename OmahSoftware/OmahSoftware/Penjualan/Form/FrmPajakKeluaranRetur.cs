...
namespace OmahSoftware.Penjualan {
    public partial class FrmPajakKeluaranRetur : DevExpress.XtraEditors.XtraForm {
        private String id = "PAJAKKELUARANRETUR";
        private String dokumen = "PAJAKKELUARANRETUR";

        public FrmPajakKeluaranRetur() {
            InitializeComponent();
        }

        private void FrmPajakKeluaranRetur_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptCetakReturCSV2 report = new RptCetakReturCSV2();
