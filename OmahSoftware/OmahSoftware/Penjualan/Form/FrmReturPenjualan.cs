...
namespace OmahSoftware.Penjualan {
    public partial class FrmReturPenjualan : DevExpress.XtraEditors.XtraForm {
        ...
        private void FrmReturPenjualan_Load(object sender, EventArgs e) {
        ...
        public void setGrid(MySqlCommand command) {
            ...
            String strngNoFaktur = txtNoFaktur.Text;
            String strngCustomer = cmbCustomer.EditValue == null ? "" : cmbCustomer.EditValue.ToString();

            String query = @"SELECT A.kode AS Nomor, A.tanggal AS Tanggal, B.nama AS Customer, A.fakturpenjualan AS 'Faktur Penjualan', A.grandtotal AS Nominal
                            ...
                            WHERE toDate(A.tanggal) BETWEEN toDate(@tanggalawal) AND toDate(@tanggalakhir) AND 
                                  A.kode LIKE @kode AND A.customer LIKE @customer AND A.fakturpenjualan LIKE @fakturpenjualan
                            ORDER BY A.kode";

            Dictionary<String, String> parameters = new Dictionary<String, String>();
            parameters.Add("tanggalawal", strngTanggalAwal);
            parameters.Add("tanggalakhir", strngTanggalAkhir);
            parameters.Add("fakturpenjualan", "%" + strngNoFaktur + "%");
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmReturPenjualanAdd form = new FrmReturPenjualanAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmReturPenjualanAdd form = new FrmReturPenjualanAdd(true);
            this.AddOwnedForm(form);
            form.ShowDialog();
        }
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if(OswPesan.pesanKonfirmasiHapus() == DialogResult.Yes) {
                    ...
                    dReturPenjualan.hapus();

                    // tulis log
                    OswLog.setTransaksi(command, "Hapus " + dokumen, dReturPenjualan.ToString());
