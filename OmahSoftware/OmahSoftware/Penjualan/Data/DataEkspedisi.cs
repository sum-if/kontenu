...
namespace OmahSoftware.Penjualan {
    class DataEkspedisi {
        ...
        public DataEkspedisi(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataEkspedisi dEkspedisi = new DataEkspedisi(command, kode);
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO ekspedisi(kode,nama,status,version,create_user) 
        ...
        private void valVersion() {
            DataEkspedisi dEkspedisi = new DataEkspedisi(command, this.kode);
            if(this.version != dEkspedisi.version) {
