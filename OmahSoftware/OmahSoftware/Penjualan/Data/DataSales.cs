...
namespace OmahSoftware.Penjualan {
    class DataSales {
        ...
        public DataSales(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataSales dSales = new DataSales(command, kode);
            if(dSales.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO sales(kode,nama,status,version,create_user) 
        ...
        private void valVersion() {
            DataSales dSales = new DataSales(command, this.kode);
            if(this.version != dSales.version) {
