...
namespace OmahSoftware.Penjualan {
    class DataKotaGroup {
        ...
        public DataKotaGroup(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataKotaGroup dKotaGroup = new DataKotaGroup(command, kode);
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO kotagroup(kode,nama,status,version,create_user) 
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM kotagroup
                             WHERE kode = @kode";
        ...
        private void valVersion() {
            DataKotaGroup dKotaGroup = new DataKotaGroup(command, this.kode);
            if(this.version != dKotaGroup.version) {
