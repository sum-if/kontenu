...
namespace OmahSoftware.Penjualan {
    class DataKota {
        ...
        public override string ToString() {
            ...
            kolom += "Kode:" + kode + ";";
            kolom += "Nama:" + nama + ";";
            kolom += "Kota Group:" + kotagroup + ";";
            kolom += "Status:" + status + ";";
            kolom += "Version:" + version + ";";
            return kolom;
        }

        public DataKota(MySqlCommand command, String kode) {
        ...
        private void getOtherAttribute() {
            ...
            String query = @"SELECT nama,kotagroup,status,version
                             FROM kota 
                             WHERE kode = @kode";
            ...
            if(reader.Read()) {
                ...
                this.kotagroup = reader.GetString("kotagroup");
        ...
        private String generateKode() {
            ...
            DataKota dKota = new DataKota(command, kode);
            if(dKota.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO kota(kode,nama,kotagroup,status,version,create_user) 
                             VALUES(@kode,@nama,@kotagroup,@status,@version,@create_user)";

            Dictionary<String, object> parameters = new Dictionary<String, object>();
            parameters.Add("kode", this.kode);
            parameters.Add("nama", this.nama);
            parameters.Add("kotagroup", this.kotagroup);
        ...
        private void valVersion() {
            DataKota dKota = new DataKota(command, this.kode);
            if(this.version != dKota.version) {
