...
namespace OmahSoftware.Pembelian {
    public partial class FrmSupplier : DevExpress.XtraEditors.XtraForm {
        ...
        public void setGrid(MySqlCommand command) {
            ...
            String query = @"SELECT A.kode AS Nomor, A.nama AS Nama, B.nama AS Kota, A.alamat AS Alamat, A.cp AS CP, A.telp AS Telp, A.npwpkode AS NPWP
                            FROM supplier A
                            INNER JOIN kota B ON A.kota = B.kode
                            WHERE A.kode LIKE @kode AND A.nama LIKE @nama AND A.alamat LIKE @alamat AND A.telp LIKE @telp
                            ORDER BY A.kode";
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmSupplierAdd form = new FrmSupplierAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmSupplierAdd form = new FrmSupplierAdd(true);
            this.AddOwnedForm(form);
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if(OswPesan.pesanKonfirmasiHapus() == DialogResult.Yes) {
                    ...
                    // tulis log
                    OswLog.setTransaksi(command, "Hapus " + dokumen, dSupplier.ToString());
