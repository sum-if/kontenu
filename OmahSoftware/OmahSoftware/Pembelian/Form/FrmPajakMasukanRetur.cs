...
namespace OmahSoftware.Pembelian {
    public partial class FrmPajakMasukanRetur : DevExpress.XtraEditors.XtraForm {
        private String id = "PAJAKMASUKANRETUR";
        private String dokumen = "PAJAKMASUKANRETUR";

        public FrmPajakMasukanRetur() {
            InitializeComponent();
        }

        private void FrmPajakMasukanRetur_Load(object sender, EventArgs e) {
