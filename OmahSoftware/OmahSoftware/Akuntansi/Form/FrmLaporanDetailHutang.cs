...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanDetailHutang : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANDETAILHUTANG";
        private String dokumen = "LAPORANDETAILHUTANG";

        public FrmLaporanDetailHutang() {
            InitializeComponent();
        }

        private void FrmLaporanDetailHutang_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptLaporanDetailHutang report = new RptLaporanDetailHutang();
