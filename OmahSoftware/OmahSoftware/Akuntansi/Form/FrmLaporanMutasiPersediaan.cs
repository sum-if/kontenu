...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanMutasiPersediaan : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANMUTASIPERSEDIAAN";
        private String dokumen = "LAPORANMUTASIPERSEDIAAN";

        public FrmLaporanMutasiPersediaan() {
            InitializeComponent();
        }

        private void FrmLaporanMutasiPersediaan_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptLaporanMutasiPersediaan report = new RptLaporanMutasiPersediaan();
