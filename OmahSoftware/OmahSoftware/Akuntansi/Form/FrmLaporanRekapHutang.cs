...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanRekapHutang : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANREKAPHUTANG";
        private String dokumen = "LAPORANREKAPHUTANG";

        public FrmLaporanRekapHutang() {
            InitializeComponent();
        }

        private void FrmLaporanRekapHutang_Load(object sender, EventArgs e) {
