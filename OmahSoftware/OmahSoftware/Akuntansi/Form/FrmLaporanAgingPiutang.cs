...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanAgingPiutang : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANAGINGPIUTANG";
        private String dokumen = "LAPORANAGINGPIUTANG";

        public FrmLaporanAgingPiutang() {
            InitializeComponent();
        }

        private void FrmLaporanAgingPiutang_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptAgingPiutang report = new RptAgingPiutang();
                ...
                report.Parameters["judulReport"].Value = "LAPORAN UMUR PIUTANG";
