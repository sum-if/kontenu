...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanKartuUangTitipanCustomer : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANKARTUUANGTITIPANCUSTOMER";
        private String dokumen = "LAPORANKARTUUANGTITIPANCUSTOMER";

        public FrmLaporanKartuUangTitipanCustomer() {
            InitializeComponent();
        }

        private void FrmLaporanKartuUangTitipanCustomer_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptKartuUangTitipanCustomer report = new RptKartuUangTitipanCustomer();

                report.Parameters["GUID"].Value = OswConstants.GUID;
                report.Parameters["judulReport"].Value = "KARTU UANG TITIPAN CUSTOMER";
