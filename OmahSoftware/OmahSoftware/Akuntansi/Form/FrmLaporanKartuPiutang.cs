...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanKartuPiutang : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANKARTUPIUTANG";
        private String dokumen = "LAPORANKARTUPIUTANG";

        public FrmLaporanKartuPiutang() {
            InitializeComponent();
        }

        private void FrmLaporanKartuPiutang_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptKartuPiutang report = new RptKartuPiutang();
                ...
                report.Parameters["judulReport"].Value = "KARTU PIUTANG " + dCustomer.nama + " [" + dKota.nama + "]";
