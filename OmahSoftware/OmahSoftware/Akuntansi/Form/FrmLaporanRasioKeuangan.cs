...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanRasioKeuangan : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANRASIOKEUANGAN";
        private String dokumen = "LAPORANRASIOKEUANGAN";

        public FrmLaporanRasioKeuangan() {
            InitializeComponent();
        }

        private void FrmLaporanRasioKeuangan_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptRasioKeuangan report = new RptRasioKeuangan();
                report.Parameters["GUID"].Value = OswConstants.GUID;
                report.Parameters["judulReport"].Value = "LAPORAN RASIO KEUANGAN";
