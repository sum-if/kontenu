...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanNeracaLajur : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANNERACALAJUR";
        private String dokumen = "LAPORANNERACALAJUR";

        public FrmLaporanNeracaLajur() {
            InitializeComponent();
        }

        private void FrmLaporanNeracaLajur_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                String strngPeriode2 = strngTahun + strngBulan;
                
                DataOswPerusahaan dPerusahaan = new DataOswPerusahaan(command);

                RptNeracaLajur report = new RptNeracaLajur();
                report.Parameters["namaPerusahaan"].Value = dPerusahaan.nama.ToUpper();
                report.Parameters["judul"].Value = "NERACA LAJUR".ToUpper();
                report.Parameters["periode"].Value = strngPeriode.ToUpper();
                report.Parameters["periode2"].Value = strngPeriode2;
