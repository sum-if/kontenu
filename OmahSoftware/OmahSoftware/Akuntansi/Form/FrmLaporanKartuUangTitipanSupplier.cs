...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanKartuUangTitipanSupplier : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANKARTUUANGTITIPANSUPPLIER";
        private String dokumen = "LAPORANKARTUUANGTITIPANSUPPLIER";

        public FrmLaporanKartuUangTitipanSupplier() {
            InitializeComponent();
        }

        private void FrmLaporanKartuUangTitipanSupplier_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptKartuUangTitipanSupplier report = new RptKartuUangTitipanSupplier();

                report.Parameters["GUID"].Value = OswConstants.GUID;
                report.Parameters["judulReport"].Value = "KARTU UANG TITIPAN SUPPLIER";
