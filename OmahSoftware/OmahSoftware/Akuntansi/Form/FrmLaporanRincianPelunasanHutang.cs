...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanRincianPelunasanHutang : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANRINCIANPELUNASANHUTANG";
        private String dokumen = "LAPORANRINCIANPELUNASANHUTANG";

        public FrmLaporanRincianPelunasanHutang() {
            InitializeComponent();
        }

        private void FrmLaporanRincianPelunasanHutang_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptRincianPelunasanHutang report = new RptRincianPelunasanHutang();
                DataSupplier dSupplier = new DataSupplier(command, strngSupplier);

                report.Parameters["GUID"].Value = OswConstants.GUID;
                report.Parameters["judulReport"].Value = "LAPORAN RINCIAN PELUNASAN HUTANG";
