...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanAnalisaHPP : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANANALISAHPP";
        private String dokumen = "LAPORANANALISAHPP";

        public FrmLaporanAnalisaHPP() {
            InitializeComponent();
        }

        private void FrmLaporanAnalisaHPP_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptAnalisaHPP report = new RptAnalisaHPP();
                report.Parameters["GUID"].Value = OswConstants.GUID;
                report.Parameters["judulReport"].Value = "LAPORAN ANALISA HPP";
