...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanJurnalUmum : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANJURNALUMUM";
        private String dokumen = "LAPORANJURNALUMUM";

        public FrmLaporanJurnalUmum() {
            InitializeComponent();
        }

        private void FrmLaporanJurnalUmum_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                String strngReferensi = txtReferensi.Text;

                RptJurnalUmum report = new RptJurnalUmum();

                
                report.Parameters["judulReport"].Value = "JURNAL UMUM";
                
                report.Parameters["tanggalAwal"].Value = strngTanggalAwal;
                report.Parameters["tanggalAkhir"].Value = strngTanggalAkhir;
                report.Parameters["tanggalAwalAkhir"].Value = strngTanggalAkhir+" - "+strngTanggalAwal;
                report.Parameters["kodeAkun"].Value = "%" + strngAkun + "%"; ;
                report.Parameters["noReferensi"].Value = "%" + strngReferensi + "%";
