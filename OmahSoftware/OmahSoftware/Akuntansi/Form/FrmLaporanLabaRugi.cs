...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanLabaRugi : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANLABARUGI";
        private String dokumen = "LAPORANLABARUGI";

        public FrmLaporanLabaRugi() {
            InitializeComponent();
        }

        private void FrmLaporanLabaRugi_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                String strngTanggalAkhir = OswDate.getTanggal(OswDate.getStringTanggalAkhirBulan(strngTahun + strngBulan));

                String strngJudul = "Untuk Periode Yang Berakhir Per " + strngTanggalAkhir + " " + strngNamaBulan + " " + strngTahun;
                
                DataOswPerusahaan dPerusahaan = new DataOswPerusahaan(command);

                RptLabaRugi report = new RptLabaRugi();
                report.Parameters["namaPerusahaan"].Value = dPerusahaan.nama.ToUpper();
                report.Parameters["judul"].Value = strngJudul;
