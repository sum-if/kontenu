...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanDetailPiutang : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANDETAILPIUTANG";
        private String dokumen = "LAPORANDETAILPIUTANG";

        public FrmLaporanDetailPiutang() {
            InitializeComponent();
        }

        private void FrmLaporanDetailPiutang_Load(object sender, EventArgs e) {
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                RptLaporanDetailPiutang report = new RptLaporanDetailPiutang();
