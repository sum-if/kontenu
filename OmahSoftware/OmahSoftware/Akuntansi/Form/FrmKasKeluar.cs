...
namespace OmahSoftware.Akuntansi {
    public partial class FrmKasKeluar : DevExpress.XtraEditors.XtraForm {
        ...
        private void FrmKasKeluar_Load(object sender, EventArgs e) {
            ...
            try {
                ...
                cmbKasKeluar = ComboQueryUmum.getAkun(cmbKasKeluar, command, "akun_input_kas_keluar", true);
                cmbKasKeluar.EditValue = OswCombo.getFirstEditValue(cmbKasKeluar);
        ...
        public void setGrid(MySqlCommand command) {
            ...
            String strngKasKeluar = cmbKasKeluar.EditValue.ToString();
            String strngCatatan = txtCatatan.Text;


            String query = @"SELECT A.kode AS Nomor, A.tanggal AS Tanggal, B.kode AS 'Kode Akun Kas Keluar', B.nama AS 'Nama Akun Kas Keluar', A.nourut AS 'No Urut', A.total AS Total,A.catatan AS Catatan
                            FROM kaskeluar A
            ...
            parameters.Add("akun", strngKasKeluar);
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmKasKeluarAdd form = new FrmKasKeluarAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmKasKeluarAdd form = new FrmKasKeluarAdd(true);
            this.AddOwnedForm(form);
            form.ShowDialog();
        }
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if(OswPesan.pesanKonfirmasiHapus() == DialogResult.Yes) {
                    ...
                    // tulis log
                    OswLog.setTransaksi(command, "Hapus " + dokumen, dKasKeluar.ToString());
