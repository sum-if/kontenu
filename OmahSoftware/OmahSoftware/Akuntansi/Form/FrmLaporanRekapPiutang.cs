...
namespace OmahSoftware.Akuntansi {
    public partial class FrmLaporanRekapPiutang : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANREKAPPIUTANG";
        private String dokumen = "LAPORANREKAPPIUTANG";

        public FrmLaporanRekapPiutang() {
            InitializeComponent();
        }

        private void FrmLaporanRekapPiutang_Load(object sender, EventArgs e) {
