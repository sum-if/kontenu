...
namespace OmahSoftware.Akuntansi {
    class DataAkunGroup {
        ...
        public DataAkunGroup(MySqlCommand command, String kode) {
        ...
        private void getOtherAttribute() {
            ...
            String query = @"SELECT nama,akunsubkategori,version
                             FROM akungroup 
                             WHERE kode = @kode";
        ...
        private String generateKode() {
            ...
            String strngAkunSubKategori = this.akunsubkategori;
            ...
            DataAkunGroup dAkunGroup = new DataAkunGroup(command, kode);
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO akungroup(kode,nama,akunsubkategori,version,create_user) 
                             VALUES(@kode,@nama,@akunsubkategori,@version,@create_user)";
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM akungroup
                             WHERE kode = @kode";
        ...
        private void valVersion() {
            DataAkunGroup dAkunGroup = new DataAkunGroup(command, this.kode);
            if(this.version != dAkunGroup.version) {
