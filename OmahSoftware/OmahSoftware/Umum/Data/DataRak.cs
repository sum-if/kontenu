...
namespace OmahSoftware.Umum {
    class DataRak {
        ...
        public DataRak(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataRak dRak = new DataRak(command, kode);
            if(dRak.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO barangrak(kode,nama,status,version,create_user) 
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM barangrak
                             WHERE kode = @kode";
        ...
        private void valVersion() {
            DataRak dRak = new DataRak(command, this.kode);
            if(this.version != dRak.version) {
