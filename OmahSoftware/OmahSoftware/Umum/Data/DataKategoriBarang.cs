...
namespace OmahSoftware.Umum {
    class DataKategoriBarang {
        ...
        public DataKategoriBarang(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataKategoriBarang dKategoriBarang = new DataKategoriBarang(command, kode);
            if(dKategoriBarang.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO barangkategori(kode,nama,status,version,create_user) 
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM barangkategori
                             WHERE kode = @kode";
        ...
        public void ubah() {
            ...
            // proses ubah
            String query = @"UPDATE barangkategori
                             SET nama = @nama,
                                 status = @status,
                                 version = @version,
        ...
        private void valVersion() {
            DataKategoriBarang dKategoriBarang = new DataKategoriBarang(command, this.kode);
            if(this.version != dKategoriBarang.version) {
