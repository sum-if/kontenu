...
namespace OmahSoftware.Umum {
    class DataKlien {
        ...
        public DataKlien(MySqlCommand command, String kode) {
        ...
        private void getOtherAttribute() {
            ...
            String query = @"SELECT nama, alamat, provinsi, kota, kodepos, telp, email, handphone, ktp ,version
                             FROM klien 
                             WHERE kode = @kode";
        ...
        private String generateKode() {
            ...
            DataKlien dKlien = new DataKlien(command, kode);
            if(dKlien.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO klien(kode, nama, alamat, provinsi, kota, kodepos, telp, email, 
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM klien
                             WHERE kode = @kode";
        ...
        private void valVersion() {
            DataKlien dKlien = new DataKlien(command, this.kode);
            if(this.version != dKlien.version) {
