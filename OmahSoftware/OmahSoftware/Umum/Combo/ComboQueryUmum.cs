...
namespace OmahSoftware.Umum {
    public class ComboQueryUmum {
        ...
        public static SearchLookUpEdit getSupplier(SearchLookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false, Boolean isNull = false) {
            String query = @"SELECT 100 AS Urutan, A.kode AS Kode,A.nama AS Nama, B.nama AS Kota
                            FROM supplier A
            ...
            if(isNull) {
                queryTambahan += "SELECT 5 AS Urutan, '' AS Kode, '[NULL]' AS Nama,'' AS Kota UNION ";
            }

            if(pilihanSemua) {
                queryTambahan += "SELECT 10 AS Urutan, '%' AS Kode, '[Semua]' AS Nama,'' AS Kota UNION ";
            }
        ...
        public static SearchLookUpEdit getEkspedisi(SearchLookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false, Boolean pilihanTidakAda = false) {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama 
                            FROM ekspedisi
                            WHERE status = @status";
            ...
            if(pilihanTidakAda) {
                queryTambahan += "SELECT 20 AS Urutan, '' AS Kode, '[Tidak Ada]' AS Nama UNION ";
            }
        ...
        public static LookUpEdit getBarangKategori(LookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false) {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama 
                            FROM barangkategori
                            WHERE status = @status";
        ...
        public static SearchLookUpEdit getBarangKategori(SearchLookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false) {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama 
                            FROM barangkategori
                            WHERE status = @status";
        ...
        public static LookUpEdit getBarangSatuan(LookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false) {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama 
                            FROM barangsatuan
                            WHERE status = @status";
        ...
        public static LookUpEdit getBarangRak(LookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false) {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama 
                            FROM barangrak
                            WHERE status = @status";
        ...
        public static SearchLookUpEdit getCustomer(SearchLookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false) {
            String query = @"SELECT 100 AS Urutan, A.kode AS Kode,A.nama AS Nama, B.nama AS Kota  
                            FROM customer A
                            INNER JOIN kota B ON A.kota = B.kode
                            WHERE A.status = @status";
        ...
        public static SearchLookUpEdit getKotaGroup(SearchLookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false) {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama  
                            FROM kotagroup 
                            WHERE status = @status";
        ...
        public static SearchLookUpEdit getKota(SearchLookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false) {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama  
                            FROM kota
                            WHERE status = @status";
        ...
        public static SearchLookUpEdit getSales(SearchLookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false) {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama  
                            FROM sales
                            WHERE status = @status";
        ...
        public static SearchLookUpEdit getBarang(SearchLookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false) {
            String query = @"SELECT 100 AS Urutan, A.kode AS Kode, A.nama AS Nama, A.nopart AS 'No Part', D.nama AS Rak, B.nama AS Kategori, C.nama AS Satuan, A.keterangan AS Keterangan
                                FROM barang A
            ...
            if(pilihanSemua) {
                queryTambahan += "SELECT 10 AS Urutan, '%' AS Kode, '[Semua]' AS Nama, '-' AS 'No Part', '' AS Rak, '' AS Kategori, '' AS Satuan, '' AS Keterangan UNION ";
            }
