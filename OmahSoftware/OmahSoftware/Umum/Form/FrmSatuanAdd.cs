...
namespace OmahSoftware.Umum {
    public partial class FrmSatuanAdd : DevExpress.XtraEditors.XtraForm {
        private String id = "SATUAN";
        private String dokumen = "SATUAN";
        private Boolean isAdd;

        public FrmSatuanAdd(bool pIsAdd) {
            isAdd = pIsAdd;
            InitializeComponent();
        }

        private void FrmSatuanAdd_Load(object sender, EventArgs e) {
        ...
        private void setDefaultInput(MySqlCommand command) {
            if(!this.isAdd) {
                ...
                // data
                DataSatuan dSatuan = new DataSatuan(command, strngKode);
                txtNama.EditValue = dSatuan.nama;

                if(dSatuan.status == Constants.STATUS_AKTIF) {
        ...
        private void btnSimpan_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                dSatuan.nama = strngNama;
                dSatuan.status = strngStatus;
                ...
                // tulis log
                OswLog.setTransaksi(command, dokumen, dSatuan.ToString());

                // reload grid di form header
                FrmSatuan frmSatuan = (FrmSatuan)this.Owner;
                frmSatuan.setGrid(command);
