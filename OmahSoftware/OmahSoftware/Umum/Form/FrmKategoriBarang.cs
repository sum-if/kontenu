...
namespace OmahSoftware.Umum {
    public partial class FrmKategoriBarang : DevExpress.XtraEditors.XtraForm {
        private String id = "KATEGORIBARANG";
        private String dokumen = "KATEGORIBARANG";

        public FrmKategoriBarang() {
            InitializeComponent();
        }

        private void FrmKategoriBarang_Load(object sender, EventArgs e) {
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmKategoriBarangAdd form = new FrmKategoriBarangAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmKategoriBarangAdd form = new FrmKategoriBarangAdd(true);
            this.AddOwnedForm(form);
            form.txtKode.Text = "";
            form.ShowDialog();
        }
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if(OswPesan.pesanKonfirmasiHapus() == DialogResult.Yes) {
                    ...
                    dKategoriBarang.hapus();

                    // tulis log
                    OswLog.setTransaksi(command, "Hapus " + dokumen, dKategoriBarang.ToString());
