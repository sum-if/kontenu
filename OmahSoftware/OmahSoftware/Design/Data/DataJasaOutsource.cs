...
namespace OmahSoftware.Master {
    class DataJasaOutsource {
        ...
        public DataJasaOutsource(MySqlCommand command, String kode) {
        ...
        private void getOtherAttribute() {
            ...
            String query = @"SELECT nama, unit,version
                             FROM jasaoutsource 
                             WHERE kode = @kode";
        ...
        private String generateKode() {
            ...
            DataJasaOutsource dJasaOutsource = new DataJasaOutsource(command, kode);
            if(dJasaOutsource.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO jasaoutsource(kode, nama, unit, version, create_user) 
                                 VALUES(@kode, @nama, @unit, @version, @create_user)";
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM jasaoutsource
                             WHERE kode = @kode";
        ...
        public void ubah() {
            ...
            // proses ubah
            String query = @"UPDATE jasaoutsource
                             SET nama = @nama,
                                 unit = @unit,
                                 version = @version,
        ...
        private void valVersion() {
            DataJasaOutsource dJasaOutsource = new DataJasaOutsource(command, this.kode);
            if(this.version != dJasaOutsource.version) {
