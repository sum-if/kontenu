...
namespace OmahSoftware.Master {
    public partial class FrmJasaOutsource : DevExpress.XtraEditors.XtraForm {
        private String id = "JASAOUTSOURCE";
        private String dokumen = "JASAOUTSOURCE";

        public FrmJasaOutsource() {
            InitializeComponent();
        }

        private void FrmJasaOutsource_Load(object sender, EventArgs e) {
        ...
        public void setGrid(MySqlCommand command) {
            ...
            String query = @"SELECT A.kode AS Kode, A.nama AS Nama, B.nama AS Unit
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmJasaOutsourceAdd form = new FrmJasaOutsourceAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmJasaOutsourceAdd form = new FrmJasaOutsourceAdd(true);
            this.AddOwnedForm(form);
            form.ShowDialog();
        }
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if(OswPesan.pesanKonfirmasiHapus() == DialogResult.Yes) {
                    ...
                    dJasaOutsource.hapus();

                    // tulis log
                    OswLog.setTransaksi(command, "Hapus " + dokumen, dJasaOutsource.ToString());
