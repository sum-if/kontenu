...
namespace OmahSoftware.Persediaan {
    public partial class FrmLaporanKartuStok : DevExpress.XtraEditors.XtraForm {
        private String id = "LAPORANKARTUSTOK";
        private String dokumen = "LAPORANKARTUSTOK";
        ...
        private void FrmLaporanKartuStok_Load(object sender, EventArgs e) {
            ...
            try {
                ...
                cmbBarang = ComboQueryUmum.getBarang(cmbBarang, command, true);
                cmbBarang.EditValue = OswCombo.getFirstEditValue(cmbBarang);
        ...
        private void btnCetak_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                String strngKodeBarang = cmbBarang.EditValue.ToString();

                RptLaporanKartuStok report = new RptLaporanKartuStok();
                ...
                report.Parameters["periode"].Value = strngTanggalAwal + " - " + strngTanggalAkhir;
                report.Parameters["kodeBarang"].Value = strngKodeBarang;
