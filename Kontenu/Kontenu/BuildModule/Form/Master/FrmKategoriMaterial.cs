...
namespace Kontenu.Master {
    public partial class FrmKategoriMaterial : DevExpress.XtraEditors.XtraForm {
        private String id = "KATEGORIMATERIAL";
        private String dokumen = "KATEGORIMATERIAL";

        public FrmKategoriMaterial() {
            InitializeComponent();
        }

        private void FrmKategoriMaterial_Load(object sender, EventArgs e) {
        ...
        public void setGrid(MySqlCommand command) {
            ...
            String query = @"SELECT A.kode AS Kode, A.nama AS Nama, A.jeniscosting AS 'Jenis Costing'
                            FROM kategorimaterial A
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmKategoriMaterialAdd form = new FrmKategoriMaterialAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmKategoriMaterialAdd form = new FrmKategoriMaterialAdd(true);
            this.AddOwnedForm(form);
            form.ShowDialog();
        }
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if(OswPesan.pesanKonfirmasiHapus() == DialogResult.Yes) {
                    ...
                    dKategoriMaterial.hapus();

                    // tulis log
                    // OswLog.setTransaksi(command, "Hapus " + dokumen, dKategoriMaterial.ToString());
