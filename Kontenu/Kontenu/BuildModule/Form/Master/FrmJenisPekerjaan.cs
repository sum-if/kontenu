...
namespace Kontenu.Master {
    public partial class FrmJenisPekerjaan : DevExpress.XtraEditors.XtraForm {
        private String id = "JENISPEKERJAAN";
        private String dokumen = "JENISPEKERJAAN";

        public FrmJenisPekerjaan() {
            InitializeComponent();
        }

        private void FrmJenisPekerjaan_Load(object sender, EventArgs e) {
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmJenisPekerjaanAdd form = new FrmJenisPekerjaanAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmJenisPekerjaanAdd form = new FrmJenisPekerjaanAdd(true);
            this.AddOwnedForm(form);
            form.ShowDialog();
        }
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if(OswPesan.pesanKonfirmasiHapus() == DialogResult.Yes) {
                    ...
                    dJenisPekerjaan.hapus();

                    // tulis log
                    // OswLog.setTransaksi(command, "Hapus " + dokumen, dJenisPekerjaan.ToString());
