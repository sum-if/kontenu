...
namespace Kontenu.Master {
    class DataKategoriMaterial {
        private String id = "KATEGORIMATERIAL";
        public String kode = "";
        public String nama = "";
        public String jeniscosting = "";
        ...
        public override string ToString() {
            ...
            kolom += "Kode:" + kode + ";";
            kolom += "Nama:" + nama + ";";
            kolom += "Jenis Costing:" + jeniscosting + ";";
            kolom += "Version:" + version + ";";
            return kolom;
        }

        public DataKategoriMaterial(MySqlCommand command, String kode) {
        ...
        private void getOtherAttribute() {
            ...
            String query = @"SELECT nama, jeniscosting,version
                             FROM kategorimaterial 
                             WHERE kode = @kode";
            ...
            if(reader.Read()) {
                ...
                this.jeniscosting = reader.GetString("jeniscosting");
        ...
        private String generateKode() {
            ...
            DataKategoriMaterial dKategoriMaterial = new DataKategoriMaterial(command, kode);
            if(dKategoriMaterial.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO kategorimaterial(kode, nama, jeniscosting, version, create_user) 
                                 VALUES(@kode, @nama, @jeniscosting, @version, @create_user)";

            Dictionary<String, object> parameters = new Dictionary<String, object>();
            parameters.Add("kode", this.kode);
            parameters.Add("nama", this.nama);
            parameters.Add("jeniscosting", this.jeniscosting);
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM kategorimaterial
                             WHERE kode = @kode";
        ...
        public void ubah() {
            ...
            // proses ubah
            String query = @"UPDATE kategorimaterial
                             SET nama = @nama,
                                 jeniscosting = @jeniscosting,
                                 version = @version,
        ...
        private void valVersion() {
            DataKategoriMaterial dKategoriMaterial = new DataKategoriMaterial(command, this.kode);
            if(this.version != dKategoriMaterial.version) {
