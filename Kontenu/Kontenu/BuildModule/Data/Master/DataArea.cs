...
namespace Kontenu.Master {
    class DataArea {
        ...
        public DataArea(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataArea dArea = new DataArea(command, kode);
            if(dArea.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO area(kode, nama, version, create_user) 
        ...
        private void valVersion() {
            DataArea dArea = new DataArea(command, this.kode);
            if(this.version != dArea.version) {
