...
namespace Kontenu.Master {
    class DataSupplier {
        ...
        private void getOtherAttribute() {
            ...
            String query = @"SELECT nama, alamat, provinsi, kota, kodepos, telp, email, handphone, jatuhtempo ,version
                             FROM supplier 
                             WHERE kode = @kode";
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO supplier(kode, nama, alamat, provinsi, kota, kodepos, telp, email, 
