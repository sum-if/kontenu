...
namespace Kontenu.Master {
    class DataItem {
        ...
        public DataItem(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataItem dItem = new DataItem(command, kode);
            if(dItem.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO item(kode, nama, version, create_user) 
        ...
        private void valVersion() {
            DataItem dItem = new DataItem(command, this.kode);
            if(this.version != dItem.version) {
