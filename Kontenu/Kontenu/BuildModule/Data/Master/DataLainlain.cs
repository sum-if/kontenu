...
namespace Kontenu.Master {
    class DataLainlain {
        ...
        public DataLainlain(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataLainlain dLainlain = new DataLainlain(command, kode);
            if(dLainlain.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO lainlain(kode, nama, version, create_user) 
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM lainlain
                             WHERE kode = @kode";
        ...
        private void valVersion() {
            DataLainlain dLainlain = new DataLainlain(command, this.kode);
            if(this.version != dLainlain.version) {
