...
namespace Kontenu.Akuntansi {
    class DataAkunSubKategori {
        ...
        public DataAkunSubKategori(MySqlCommand command, String kode) {
        ...
        private void getOtherAttribute() {
            ...
            String query = @"SELECT nama,akunkategori,version
        ...
        private String generateKode() {
            ...
            String strngAkunKategori = this.akunkategori;
            ...
            DataAkunSubKategori dAkunSubKategori = new DataAkunSubKategori(command, kode);
            if(dAkunSubKategori.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO akunsubkategori(kode,nama,akunkategori,version,create_user) 
                             VALUES(@kode,@nama,@akunkategori,@version,@create_user)";
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM akunsubkategori
                             WHERE kode = @kode";
        ...
        public void ubah() {
            ...
            // proses ubah
            String query = @"UPDATE akunsubkategori
                             SET nama = @nama,
        ...
        private void valVersion() {
            DataAkunSubKategori dAkunSubKategori = new DataAkunSubKategori(command, this.kode);
            if(this.version != dAkunSubKategori.version) {
