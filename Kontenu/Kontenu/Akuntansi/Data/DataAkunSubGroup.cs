...
namespace Kontenu.Akuntansi {
    class DataAkunSubGroup {
        ...
        public DataAkunSubGroup(MySqlCommand command, String kode) {
        ...
        private void getOtherAttribute() {
            ...
            String query = @"SELECT nama,akungroup,version
                             FROM akunsubgroup 
                             WHERE kode = @kode";
        ...
        private String generateKode() {
            ...
            String strngAkunGroup = this.akungroup;
            ...
            DataAkunSubGroup dAkunSubGroup = new DataAkunSubGroup(command, kode);
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO akunsubgroup(kode,nama,akungroup,version,create_user) 
                             VALUES(@kode,@nama,@akungroup,@version,@create_user)";
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM akunsubgroup
                             WHERE kode = @kode";
        ...
        public void ubah() {
            ...
            // proses ubah
            String query = @"UPDATE akunsubgroup
                             SET nama = @nama,
                                 akungroup = @akungroup,
                                 version = @version,
        ...
        private void valVersion() {
            DataAkunSubGroup dAkunSubGroup = new DataAkunSubGroup(command, this.kode);
            if(this.version != dAkunSubGroup.version) {
