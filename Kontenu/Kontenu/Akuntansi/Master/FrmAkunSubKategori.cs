...
namespace Kontenu.Akuntansi {
    public partial class FrmAkunSubKategori : DevExpress.XtraEditors.XtraForm {
        private String id = "AKUNSUBKATEGORI";
        private String dokumen = "AKUNSUBKATEGORI";

        public FrmAkunSubKategori() {
            InitializeComponent();
        }

        private void FrmAkunSubKategori_Load(object sender, EventArgs e) {
        ...
        public void setGrid(MySqlCommand command) {
            ...
            String query = @"SELECT A.kode AS Kode, A.nama AS Nama, B.nama AS Kategori
                            FROM akunsubkategori A
                            INNER JOIN akunkategori B ON A.akunkategori = B.kode
                            WHERE A.kode LIKE @kode AND A.nama LIKE @nama AND A.akunkategori LIKE @akunkategori
                            ORDER BY A.kode";
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmAkunSubKategoriAdd form = new FrmAkunSubKategoriAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmAkunSubKategoriAdd form = new FrmAkunSubKategoriAdd(true);
            this.AddOwnedForm(form);
            form.ShowDialog();
        }
        ...
        private void btnHapus_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if(OswPesan.pesanKonfirmasiHapus() == DialogResult.Yes) {
                    ...
                    dAkunSubKategori.hapus();

                    // tulis log
                    OswLog.setTransaksi(command, "Hapus " + dokumen, dAkunSubKategori.ToString());
