...
namespace Kontenu.Sistem {
    public partial class SisLogLaporan : DevExpress.XtraEditors.XtraForm {
        private String id = "LOGLAPORAN";
        private String dokumen = "Log Laporan";

        public SisLogLaporan() {
            InitializeComponent();
        }
        ...
        public void setGrid(MySqlCommand command) {
            ...
            String strngLaporan = txtLaporan.Text;

            String query = @"SELECT A.user AS 'Kode User', B.nama AS 'Nama', C.nama AS Usergroup, A.hostname AS Hostname, A.ip AS IP, A.laporan AS Laporan, CAST(A.waktu AS CHAR) AS Waktu
                            FROM oswloglaporan A
            ...
            parameters.Add("laporan", "%" + strngLaporan + "%");
