...
namespace Kontenu.Umum {
    public class ComboQueryUmum {
        ...
        public static LookUpEdit getProyek(LookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false)
        {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama 
                            FROM proyek";
        ...
        public static LookUpEdit getProyekAktif(LookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false)
        {
            String query = @"SELECT 100 AS Urutan, kode AS Kode,nama AS Nama 
                            FROM proyek where status=@status";
        ...
        public static LookUpEdit getKategoriMaterial(LookUpEdit combo, MySqlCommand command, Boolean pilihanSemua = false, Boolean pilihanTidakAda = false)
        {
            String query = @"(SELECT 100 AS Urutan, kode AS Kode, nama AS Nama 
