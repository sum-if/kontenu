...
namespace Kontenu.Master {
    class DataJabatan {
        ...
        public DataJabatan(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataJabatan dJabatan = new DataJabatan(command, kode);
            if(dJabatan.isExist) {
                kode = generateKode();
            }
        ...
        public void tambah() {
            ...
            String query = @"INSERT INTO jabatan(kode, nama, version, create_user) 
        ...
        private void valVersion() {
            DataJabatan dJabatan = new DataJabatan(command, this.kode);
            if(this.version != dJabatan.version) {
