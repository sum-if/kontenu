...
namespace Kontenu.Master {
    class DataUnit {
        ...
        public DataUnit(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataUnit dUnit = new DataUnit(command, kode);
            if(dUnit.isExist) {
                kode = generateKode();
            }
        ...
        private void valVersion() {
            DataUnit dUnit = new DataUnit(command, this.kode);
            if(this.version != dUnit.version) {
