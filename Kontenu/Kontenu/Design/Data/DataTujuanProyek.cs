...
namespace Kontenu.Master {
    class DataTujuanProyek {
        ...
        public DataTujuanProyek(MySqlCommand command, String kode) {
        ...
        private String generateKode() {
            ...
            DataTujuanProyek dTujuanProyek = new DataTujuanProyek(command, kode);
            if(dTujuanProyek.isExist) {
                kode = generateKode();
            }
        ...
        public void hapus() {
            ...
            String query = @"DELETE FROM tujuanproyek
                             WHERE kode = @kode";
        ...
        public void ubah() {
            ...
            // proses ubah
            String query = @"UPDATE tujuanproyek
                             SET nama = @nama,
                                 version = @version,
        ...
        private void valVersion() {
            DataTujuanProyek dTujuanProyek = new DataTujuanProyek(command, this.kode);
            if(this.version != dTujuanProyek.version) {
