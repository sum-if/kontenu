...
namespace Kontenu.Design
{
    public partial class FrmInvoiceAdd : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void setDefaultInput(MySqlCommand command)
        {
            ...
            //    deTanggalBerlaku.DateTime = OswDate.getDateTimeFromStringTanggal(dInvoice.tanggalberlaku);
            //    chkTutup.Checked = dInvoice.status == Constants.STATUS_INVOICE_TUTUP;
            ...
            //    // PROYEK
            //    txtProyekNama.Text = dInvoice.proyeknama;
            //    txtProyekAlamat.Text = dInvoice.proyekalamat;
            //    txtProyekKota.Text = dInvoice.proyekkota;
            //    txtProyekProvinsi.Text = dInvoice.proyekprovinsi;
            //    txtProyekKodePos.Text = dInvoice.proyekkodepos;

            //    cmbProyekTujuan.EditValue = dInvoice.tujuanproyek;
            //    cmbProyekJenis.EditValue = dInvoice.jenisproyek;
            //    cmbProyekPIC.EditValue = dInvoice.pic;
        ...
        private void cetak(String kode)
        {
            ...
            //    report.Parameters["Kode"].Value = dInvoice.kode;
            //    report.Parameters["Tanggal"].Value = dInvoice.tanggal;
            //    report.Parameters["ProyekNama"].Value = dInvoice.proyeknama;
            //    report.Parameters["ProyekAlamat"].Value = dInvoice.proyekalamat;
            //    report.Parameters["ProyekKota"].Value = dInvoice.proyekkota;
            //    report.Parameters["ProyekJenis"].Value = (new DataJenisProyek(command, dInvoice.jenisproyek)).nama;
            //    report.Parameters["ProyekTanggalBerlaku"].Value = dInvoice.tanggalberlaku;
