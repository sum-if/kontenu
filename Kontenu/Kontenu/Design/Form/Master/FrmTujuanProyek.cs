...
namespace Kontenu.Master {
    public partial class FrmTujuanProyek : DevExpress.XtraEditors.XtraForm {
        private String id = "TUJUANPROYEK";
        private String dokumen = "TUJUANPROYEK";

        public FrmTujuanProyek() {
            InitializeComponent();
        }

        private void FrmTujuanProyek_Load(object sender, EventArgs e) {
        ...
        private void btnUbah_Click(object sender, EventArgs e) {
            FrmTujuanProyekAdd form = new FrmTujuanProyekAdd(false);
            MySqlConnection con = new MySqlConnection(OswConfig.KONEKSI);
            MySqlCommand command = con.CreateCommand();
            MySqlTransaction trans;
        ...
        private void btnTambah_Click(object sender, EventArgs e) {
            FrmTujuanProyekAdd form = new FrmTujuanProyekAdd(true);
            this.AddOwnedForm(form);
            form.ShowDialog();
        }
