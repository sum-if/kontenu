...
namespace Kontenu.Master {
    public partial class FrmJabatanAdd : DevExpress.XtraEditors.XtraForm {
        private String id = "JABATAN";
        private String dokumen = "JABATAN";
        private Boolean isAdd;

        public FrmJabatanAdd(bool pIsAdd) {
            isAdd = pIsAdd;
            InitializeComponent();
        }

        private void FrmJabatanAdd_Load(object sender, EventArgs e) {
        ...
        private void btnSimpan_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                DataJabatan dJabatan = new DataJabatan(command, strngKode);
                dJabatan.nama = strngNama;

                if(this.isAdd) {
                    dJabatan.tambah();
                    // update kode header --> setelah generate
                    strngKode = dJabatan.kode;
                } else {
                    dJabatan.ubah();
                }
